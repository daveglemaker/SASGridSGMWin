...
File Reference created: results
     ...
     Sample Macro call: %mygsubque(mypgm=S:\myshared_dir\pgms\sleep1.sas,que=default)
...
options spool;
filename results pipe "&gsconfigdir.\sasgsub.cmd -gridsubmitpgm &mypgm -gridjobopts 'queue=&que'";
data mygsubjob;
