...
File Reference created: gjobs 
           Limitations:
                 Notes: requires xcmd turned on and grid client CLI configured
                        ...
                        ex. S:\sas\sasconfig\Lev1\Applications\GridAdminUtiility
...
%macro gjobs;
filename gjobs pipe "&gauconfigdir\sas-grid-cli.cmd --mhost &mhost --mport &mport --authinfo &authinfo show-jobs --state all";

data gjobs;
   infile gjobs missover dlm=' ' firstobs=6;
      length id $25. state $20. user $20. name $18. queue $15. executionhost $20. submittime $20. starttime $20.;
